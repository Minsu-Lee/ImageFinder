...
class NotFoundGuideUI: AnkoComponent<ViewGroup> {
        ...
        verticalLayout {
            lparams(width= matchParent, height= wrapContent) {
                ...
                relativeLayout {
                    ...
                    textView(R.string.not_found_guide_str) {

                        setTextSize(TypedValue.COMPLEX_UNIT_PX, resources.getDimension(R.dimen.not_found_guide_size))
